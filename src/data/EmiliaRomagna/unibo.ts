...
export const uniboRooms: StudyRoom[] = [
    ...
    // ============================================================
    // BOLOGNA - AULE STUDIO ER.GO (Ente Regionale Diritto allo Studio)
    // ============================================================
    {
        id: 'unibo_ergo_paleotti',
        nome: 'Sala Studio ER.GO Paleotti',
        edificio: 'Palazzo Paleotti (ER.GO)',
        piano: 0,
        postiDisponibili: 100,
        postiTotali: 150,
        orarioApertura: '09:00',
        ...
        latitude: 44.4965,
        longitude: 11.3505,
        indirizzo: 'Via Zamboni 25, 40126 Bologna',
        university: 'UniBo',
        occupancy_rate: 'Molto Alto',
        extendedHours: true,
        notes: 'Gestita da ER.GO. Situata su Via Zamboni, la "via dell\'università" di Bologna. 150 posti con WiFi e prese al banco. Aperta fino alle 23:00. Affollatissima in sessione, arrivare presto.',
        tags: ['Aula Studio', 'ER.GO', 'WiFi', '🌙 Serale', '⚡ Prese'],
    },
    {
        id: 'unibo_ergo_morgagni',
        nome: 'Sala Studio ER.GO Morgagni',
        edificio: 'Sede Via Morgagni (ER.GO)',
        piano: 0,
        postiDisponibili: 80,
        postiTotali: 120,
        orarioApertura: '09:00',
        orarioChiusura: '22:00',
        servizi: ['WiFi Gratuito', 'Prese elettriche', 'Climatizzazione', 'Distributori'],
        latitude: 44.4920,
        longitude: 11.3580,
        indirizzo: 'Via Giovanni Battista Morgagni 36, 40122 Bologna',
        university: 'UniBo',
        occupancy_rate: 'Alto',
        extendedHours: true,
        notes: 'Gestita da ER.GO. Vicina ai dipartimenti scientifici (zona Irnerio/Porta San Donato). 120 posti, accesso libero per tutti gli studenti universitari. Meno affollata della Paleotti.',
        tags: ['Aula Studio', 'ER.GO', 'WiFi', '🌙 Serale', '❄️ Climatizzato'],
    },
    // ============================================================
    // BOLOGNA CENTRO - SALE STUDIO AGGIUNTIVE
    // ============================================================
    {
        id: 'unibo_petroni',
        nome: 'Sala Studio Via Petroni',
        edificio: 'Via Petroni',
        piano: 0,
        postiDisponibili: 70,
        postiTotali: 106,
        orarioApertura: '08:30',
        orarioChiusura: '23:00',
        servizi: ['WiFi Eduroam', 'Affluences', 'Prese', 'Clima'],
        latitude: 44.4955,
        longitude: 11.3545,
        indirizzo: 'Via Petroni 13/b, 40126 Bologna',
        university: 'UniBo',
        occupancy_rate: 'Molto Alto',
        extendedHours: true,
        notes: 'Spazio studio nel cuore della zona universitaria. 106 posti con monitoraggio posti liberi tramite Affluences.',
        tags: ['Aula Studio', 'Centro', 'WiFi', '🌙 Serale'],
    },
    {
        id: 'unibo_baricentro',
        nome: 'Sala Studio Nuova Baricentro',
        edificio: 'Complesso Belmeloro',
        piano: 0,
        postiDisponibili: 50,
        postiTotali: 80,
        orarioApertura: '08:30',
        orarioChiusura: '20:00',
        servizi: ['WiFi Eduroam', 'Area Ristoro', 'Prese'],
        latitude: 44.4920,
        longitude: 11.3535,
        indirizzo: 'Via Belmeloro 8/2, 40126 Bologna',
        university: 'UniBo',
        occupancy_rate: 'Alto',
        notes: 'Nuova sala studio e area ristoro in zona Giurisprudenza. Inaugurata recentemente.',
        tags: ['Aula Studio', 'Giurisprudenza', 'Area Ristoro'],
    },
    // ============================================================
    // CAMPUS RIMINI - SALE STUDIO
    // ============================================================
    {
        id: 'unibo_rimini_malatesta',
        nome: 'Sala Studio Malatesta (Campus Rimini)',
        edificio: 'Sede Centro Rimini',
        piano: 0,
        postiDisponibili: 50,
        postiTotali: 80,
        orarioApertura: '08:30',
        orarioChiusura: '20:30',
        servizi: ['WiFi Eduroam', 'Badge UniBo', 'Prese'],
        latitude: 44.0610,
        longitude: 12.5680,
        indirizzo: 'Piazza Malatesta 30, 47921 Rimini',
        university: 'UniBo',
        occupancy_rate: 'Medio',
        notes: 'Sala studio del Campus di Rimini, accessibile con badge UniBo.',
        tags: ['Rimini', 'Campus', 'WiFi'],
    },
    {
        id: 'unibo_rimini_roma',
        nome: 'Sala Studio Roma (Campus Rimini)',
        edificio: 'Sede Via Roma',
        piano: 0,
        postiDisponibili: 40,
        postiTotali: 60,
        orarioApertura: '17:30',
        orarioChiusura: '23:59',
        servizi: ['WiFi Eduroam', 'Orario Serale', 'Weekend'],
        latitude: 44.0590,
        longitude: 12.5675,
        indirizzo: 'Via Roma 47, 47921 Rimini',
        university: 'UniBo',
        occupancy_rate: 'Basso',
        extendedHours: true,
        notes: 'Orario serale e weekend: venerdì-domenica e festivi 08:30-24:00, feriali dalle 17:30. Ideale per lo studio notturno a Rimini.',
        tags: ['Rimini', '🌙 Serale', 'Weekend'],
    }
];
